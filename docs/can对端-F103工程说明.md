...
| TJA1050 CAN 收发器模块 | 1 | **5 V 供电**版本（共买 2 个，天空星/F103 各一个） |
| ST-Link | 1 | 下载用（你已有） |
...
| F103C8T6 | TJA1050 模块 | 说明 |
|---|---|---|
| **PA12** (CAN_TX) | TXD | 3.3 V 直驱 OK（VIH ≥ 2.0 V） |
| **PA11** (CAN_RX) | RXD | RXD 输出 ≈ 5 V；PA11 是 **FT（5V 容忍）** 引脚可直连，稳妥串 1 kΩ |
| **5V** | VCC | ⚠️ TJA1050 必须 5 V |
| GND | GND | 共地 |
...
| 天空星 | TJA1050 模块 | 说明 |
|---|---|---|
| **PB9** (CAN1_TX) | TXD | 3.3 V 直驱 OK |
| **PB8** (CAN1_RX) | RXD | PB8 是 FT 引脚，5 V 信号可直连 |
| **5V** | VCC | ⚠️ 必须 5 V（天空星 5V 排针） |
| GND | GND | 共地 |
